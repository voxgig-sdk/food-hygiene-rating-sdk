...
|---|---|---|
| `ts/` | @voxgig-sdk/food-hygiene-rating-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/food-hygiene-rating-sdk \
      --repository voxgig-sdk/food-hygiene-rating-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/food-hygiene-rating-sdk` shows it, and
`npm trust revoke @voxgig-sdk/food-hygiene-rating-sdk --id=<id>` removes it.
