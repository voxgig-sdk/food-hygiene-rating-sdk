...
// FoodHygieneRating SDK cache feature
...
class FoodHygieneRatingCacheFeature extends FoodHygieneRatingBaseFeature
{
    ...
    private function _through(FoodHygieneRatingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
