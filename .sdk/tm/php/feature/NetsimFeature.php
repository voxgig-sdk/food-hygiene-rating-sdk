...
// FoodHygieneRating SDK netsim feature
...
class FoodHygieneRatingNetsimFeature extends FoodHygieneRatingBaseFeature
{
    ...
    private function _simulate(FoodHygieneRatingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FoodHygieneRatingContext $ctx, array $applied): void
    {
        $client = $this->client;
