...
// FoodHygieneRating SDK ratelimit feature
...
class FoodHygieneRatingRatelimitFeature extends FoodHygieneRatingBaseFeature
{
    ...
    private function _acquire(FoodHygieneRatingContext $ctx): void
    {
    ...
    private function _track(FoodHygieneRatingContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
