...
// FoodHygieneRating SDK rbac feature
...
class FoodHygieneRatingRbacFeature extends FoodHygieneRatingBaseFeature
{
    ...
    private function _required(FoodHygieneRatingContext $ctx): ?string
    {
    ...
    private function _reject(FoodHygieneRatingContext $ctx, string $required): void
    {
    ...
    private function _track(FoodHygieneRatingContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
