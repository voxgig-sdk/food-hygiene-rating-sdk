...
// FoodHygieneRating SDK utility: make_options

class FoodHygieneRatingMakeOptions
{
    ...
    public static function call(FoodHygieneRatingContext $ctx): array
    {
        ...
        //
        // `FoodHygieneRatingSchema::optspec()` is built from the model:
        ...
        $optspec = FoodHygieneRatingSchema::optspec();
