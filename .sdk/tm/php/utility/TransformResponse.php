...
// FoodHygieneRating SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FoodHygieneRatingTransformResponse
{
    public static function call(FoodHygieneRatingContext $ctx): mixed
    {
        ...
        $transform = FoodHygieneRatingHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
