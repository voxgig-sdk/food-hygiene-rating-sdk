module github.com/voxgig-sdk/food-hygiene-rating-sdk/go-cli

go 1.24.7

require github.com/voxgig-sdk/food-hygiene-rating-sdk/go v0.0.0
...
replace github.com/voxgig-sdk/food-hygiene-rating-sdk/go => ../go
