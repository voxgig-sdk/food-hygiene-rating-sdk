...
func registerSDKWords(r *eng.Registry, client *sdk.FoodHygieneRatingSDK) {
...
func runOp(client *sdk.FoodHygieneRatingSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
