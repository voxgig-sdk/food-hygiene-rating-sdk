// Command FoodHygieneRating-mcp is an MCP server exposing the FoodHygieneRating
// SDK as MCP tools.
//
// Two tools are registered:
//
//	FoodHygieneRating_list  — list records of an entity
//	FoodHygieneRating_load  — load a single record of an entity
//
