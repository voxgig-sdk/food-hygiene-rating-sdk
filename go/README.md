...
The Golang SDK for the FoodHygieneRating API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/food-hygiene-rating-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/food-hygiene-rating-sdk=../path/to/github.com/voxgig-sdk/food-hygiene-rating-sdk
```
...
```
github.com/voxgig-sdk/food-hygiene-rating-sdk/
...
The root package (`github.com/voxgig-sdk/food-hygiene-rating-sdk`) re-exports everything needed
