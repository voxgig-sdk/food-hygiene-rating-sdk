...
func (sdk *FoodHygieneRatingSDK) OptionsMap() map[string]any {
...
func (sdk *FoodHygieneRatingSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FoodHygieneRatingSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FoodHygieneRatingSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FoodHygieneRatingSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FoodHygieneRatingSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FoodHygieneRatingSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FoodHygieneRatingSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FoodHygieneRatingSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FoodHygieneRatingSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FoodHygieneRatingSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *FoodHygieneRatingSDK {
	...
	sdk := NewFoodHygieneRatingSDK(sdkopts)
	sdk.Mode = "test"
