...
func NewAuthorityEntity(client *core.FoodHygieneRatingSDK, entopts map[string]any) *AuthorityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AuthorityEntity) GetName() string { return e.name }
...
func (e *AuthorityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AuthorityEntity) Deleted() bool {
	return e.deleted
}


func (e *AuthorityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAuthorityEntity(e.client, opts)
}

func (e *AuthorityEntity) Data(args ...any) any {
...
func (e *AuthorityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Authority; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AuthorityEntity) DataTyped(data ...Authority) Authority {
	if len(data) > 0 {
		return typedFrom[Authority](e.Data(asMap(data[0])))
	}
	return typedFrom[Authority](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Authority (all fields
// optional at the wire level).
func (e *AuthorityEntity) MatchTyped(match ...Authority) Authority {
	if len(match) > 0 {
		return typedFrom[Authority](e.Match(asMap(match[0])))
	}
	return typedFrom[Authority](e.Match())
}
...
func (e *AuthorityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AuthorityEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AuthorityLoadMatch and returns an Authority. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AuthorityEntity) LoadTyped(reqmatch AuthorityLoadMatch, ctrl map[string]any) (Authority, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Authority{}, err
	}
	return typedFrom[Authority](res), nil
}




func (e *AuthorityEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// AuthorityListMatch and returns []Authority. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AuthorityEntity) ListTyped(reqmatch AuthorityListMatch, ctrl map[string]any) ([]Authority, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Authority](res), nil
}



func (e *AuthorityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AuthorityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AuthorityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AuthorityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
