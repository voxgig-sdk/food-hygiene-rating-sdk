...
type BusinessTypeEntity struct {
	name    string
...
func NewBusinessTypeEntity(client *core.FoodHygieneRatingSDK, entopts map[string]any) *BusinessTypeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BusinessTypeEntity) GetName() string { return e.name }
...
func (e *BusinessTypeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BusinessTypeEntity) Deleted() bool {
	return e.deleted
}


func (e *BusinessTypeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBusinessTypeEntity(e.client, opts)
}

func (e *BusinessTypeEntity) Data(args ...any) any {
...
func (e *BusinessTypeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BusinessType; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BusinessTypeEntity) DataTyped(data ...BusinessType) BusinessType {
	if len(data) > 0 {
		return typedFrom[BusinessType](e.Data(asMap(data[0])))
	}
	return typedFrom[BusinessType](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BusinessType (all fields
// optional at the wire level).
func (e *BusinessTypeEntity) MatchTyped(match ...BusinessType) BusinessType {
	if len(match) > 0 {
		return typedFrom[BusinessType](e.Match(asMap(match[0])))
	}
	return typedFrom[BusinessType](e.Match())
}
...
func (e *BusinessTypeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BusinessTypeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *BusinessTypeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BusinessTypeListMatch and returns []BusinessType. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BusinessTypeEntity) ListTyped(reqmatch BusinessTypeListMatch, ctrl map[string]any) ([]BusinessType, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[BusinessType](res), nil
}



func (e *BusinessTypeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BusinessTypeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BusinessTypeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BusinessTypeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
