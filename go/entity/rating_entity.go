...
func NewRatingEntity(client *core.FoodHygieneRatingSDK, entopts map[string]any) *RatingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RatingEntity) GetName() string { return e.name }
...
func (e *RatingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RatingEntity) Deleted() bool {
	return e.deleted
}


func (e *RatingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRatingEntity(e.client, opts)
}

func (e *RatingEntity) Data(args ...any) any {
...
func (e *RatingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Rating; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RatingEntity) DataTyped(data ...Rating) Rating {
	if len(data) > 0 {
		return typedFrom[Rating](e.Data(asMap(data[0])))
	}
	return typedFrom[Rating](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Rating (all fields
// optional at the wire level).
func (e *RatingEntity) MatchTyped(match ...Rating) Rating {
	if len(match) > 0 {
		return typedFrom[Rating](e.Match(asMap(match[0])))
	}
	return typedFrom[Rating](e.Match())
}
...
func (e *RatingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RatingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RatingEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RatingListMatch and returns []Rating. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RatingEntity) ListTyped(reqmatch RatingListMatch, ctrl map[string]any) ([]Rating, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Rating](res), nil
}



func (e *RatingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RatingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RatingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RatingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
