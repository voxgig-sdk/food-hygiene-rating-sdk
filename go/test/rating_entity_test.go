...
func TestRatingEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set FOODHYGIENERATING_TEST_RATING_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func ratingBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("FOODHYGIENERATING_TEST_RATING_ENTID")
