...
const testSeed = `map[string]any{"entity": map[string]any{"authority": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "business_type": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "establishment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rating": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
