-- FoodHygieneRating SDK Authority entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local AuthorityEntity = {}
AuthorityEntity.__index = AuthorityEntity


function AuthorityEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AuthorityEntity)
  self._name = "authority"
  self._client = client
...
function AuthorityEntity:get_name()
  return self._name
end


function AuthorityEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AuthorityEntity.new(self._client, opts)
end
...
function AuthorityEntity:mark_deleted()
  self._deleted = true
end


function AuthorityEntity:deleted()
  return true == self._deleted
end


function AuthorityEntity:data_set(args)
  if args ~= nil then
...
function AuthorityEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AuthorityEntity:match_set(args)
  if args ~= nil then
...
function AuthorityEntity:match_get()
...
function AuthorityEntity:stream(action, args, callopts)
...
function AuthorityEntity:_run_op(ctx, post_done)
  local utility = self._utility
