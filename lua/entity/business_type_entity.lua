...
local BusinessTypeEntity = {}
BusinessTypeEntity.__index = BusinessTypeEntity


function BusinessTypeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BusinessTypeEntity)
  self._name = "business_type"
  self._client = client
...
function BusinessTypeEntity:get_name()
  return self._name
end


function BusinessTypeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BusinessTypeEntity.new(self._client, opts)
end
...
function BusinessTypeEntity:mark_deleted()
  self._deleted = true
end


function BusinessTypeEntity:deleted()
  return true == self._deleted
end


function BusinessTypeEntity:data_set(args)
  if args ~= nil then
...
function BusinessTypeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BusinessTypeEntity:match_set(args)
  if args ~= nil then
...
function BusinessTypeEntity:match_get()
...
function BusinessTypeEntity:stream(action, args, callopts)
...
function BusinessTypeEntity:_run_op(ctx, post_done)
  local utility = self._utility
