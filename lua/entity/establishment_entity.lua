...
local EstablishmentEntity = {}
EstablishmentEntity.__index = EstablishmentEntity


function EstablishmentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EstablishmentEntity)
  self._name = "establishment"
  self._client = client
...
function EstablishmentEntity:get_name()
  return self._name
end


function EstablishmentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EstablishmentEntity.new(self._client, opts)
end
...
function EstablishmentEntity:mark_deleted()
  self._deleted = true
end


function EstablishmentEntity:deleted()
  return true == self._deleted
end


function EstablishmentEntity:data_set(args)
  if args ~= nil then
...
function EstablishmentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EstablishmentEntity:match_set(args)
  if args ~= nil then
...
function EstablishmentEntity:match_get()
...
function EstablishmentEntity:stream(action, args, callopts)
...
function EstablishmentEntity:_run_op(ctx, post_done)
  local utility = self._utility
