...
describe("BusinessTypeDirect", function()
  it("should direct-list-business_type", function()
    local setup = business_type_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-business_type", setup.live and "live" or "unit")
...
function business_type_direct_setup(mockres)
