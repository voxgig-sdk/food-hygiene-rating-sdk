...
describe("RatingDirect", function()
  it("should direct-list-rating", function()
    local setup = rating_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-rating", setup.live and "live" or "unit")
...
function rating_direct_setup(mockres)
