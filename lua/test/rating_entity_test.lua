...
describe("RatingEntity", function()
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:Rating(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:Rating(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set FOOD_HYGIENE_RATING_TEST_RATING_ENTID JSON to run live")
      return
    end
...
function rating_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("FOOD_HYGIENE_RATING_TEST_RATING_ENTID")
