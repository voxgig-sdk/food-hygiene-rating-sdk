...
local SDK_MODULE = "food-hygiene-rating_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["authority"] = { ["test01"] = { id = "test01" } }, ["business_type"] = { ["test01"] = { id = "test01" } }, ["establishment"] = { ["test01"] = { id = "test01" } }, ["rating"] = { ["test01"] = { id = "test01" } } } }'
