...
function runner.env_override(m)
  local live = runner.getenv("FOODHYGIENERATING_TEST_LIVE")
  local override = runner.getenv("FOODHYGIENERATING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FOODHYGIENERATING_TEST_EXPLAIN")
