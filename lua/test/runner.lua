...
function runner.env_override(m)
  local live = runner.getenv("FOOD_HYGIENE_RATING_TEST_LIVE")
  local override = runner.getenv("FOOD_HYGIENE_RATING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FOOD_HYGIENE_RATING_TEST_EXPLAIN")
