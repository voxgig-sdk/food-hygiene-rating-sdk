...
local function make_error_util(ctx, err)
  ...
  local msg = "FoodHygieneRatingSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = FoodHygieneRatingError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == FoodHygieneRatingError then
