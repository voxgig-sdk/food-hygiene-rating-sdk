...
// FoodHygieneRating SDK utility type

class FoodHygieneRatingUtility
{
    ...
    public static function copy(FoodHygieneRatingUtility $src): FoodHygieneRatingUtility
    {
        $u = new FoodHygieneRatingUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
