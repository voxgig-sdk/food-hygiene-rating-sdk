...
// FoodHygieneRating SDK BusinessType entity
...
class BusinessTypeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BusinessTypeEntity($this->_client, $opts);
    }

    /**
     * @param BusinessType|array $args BusinessType data (assoc-array) to store.
     */
    ...
    /**
     * @return BusinessType|array The current BusinessType data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BusinessType fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BusinessType fields).
     */
     ...
     *
     * @param BusinessTypeListMatch|array|null $reqmatch Match filter (any subset
     *   of BusinessType fields) as an assoc-array; BusinessTypeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BusinessType[]|array A list of BusinessType items as assoc-arrays at
