...
// FoodHygieneRating SDK audit feature
...
class FoodHygieneRatingAuditFeature extends FoodHygieneRatingBaseFeature
{
    ...
    private function _emit(FoodHygieneRatingContext $ctx, string $outcome): void
    {
