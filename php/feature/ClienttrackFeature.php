...
// FoodHygieneRating SDK clienttrack feature
...
class FoodHygieneRatingClienttrackFeature extends FoodHygieneRatingBaseFeature
{
    ...
    public function PostConstruct(FoodHygieneRatingContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FoodHygieneRating-SDK';
