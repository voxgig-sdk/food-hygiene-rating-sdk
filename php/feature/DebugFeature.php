...
// FoodHygieneRating SDK debug feature
...
class FoodHygieneRatingDebugFeature extends FoodHygieneRatingBaseFeature
{
    ...
    private function _finish(FoodHygieneRatingContext $ctx, bool $ok): void
    {
