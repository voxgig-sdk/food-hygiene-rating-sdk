...
// FoodHygieneRating SDK proxy feature
...
class FoodHygieneRatingProxyFeature extends FoodHygieneRatingBaseFeature
{
    ...
    public function init(FoodHygieneRatingContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FoodHygieneRatingContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
