...
// FoodHygieneRating SDK streaming feature
...
class FoodHygieneRatingStreamingFeature extends FoodHygieneRatingBaseFeature
{
    ...
    private function _iterate(FoodHygieneRatingResult $result): \Generator
    {
    ...
    private function _streamable(FoodHygieneRatingContext $ctx): bool
    {
