...
// FoodHygieneRating SDK timeout feature
...
class FoodHygieneRatingTimeoutFeature extends FoodHygieneRatingBaseFeature
{
    ...
    private function _with_timeout(FoodHygieneRatingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FoodHygieneRatingContext $_ctx, float $ms): void
    {
        $client = $this->client;
