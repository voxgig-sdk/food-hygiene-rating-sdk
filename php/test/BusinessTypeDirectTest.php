...
class BusinessTypeDirectTest extends TestCase
{
    public function test_direct_list_business_type(): void
    {
        $setup = business_type_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-business_type", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
