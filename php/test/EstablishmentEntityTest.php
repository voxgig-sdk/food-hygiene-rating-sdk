...
class EstablishmentEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FOODHYGIENERATING_TEST_ESTABLISHMENT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function establishment_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FOODHYGIENERATING_TEST_ESTABLISHMENT_ENTID");
