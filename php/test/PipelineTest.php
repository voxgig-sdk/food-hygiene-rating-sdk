...
// FoodHygieneRating SDK pipeline test
//
...
{
    private static function utility(): FoodHygieneRatingUtility
    {
        return new FoodHygieneRatingUtility();
    }
    ...
    private static function ctx(array $over = []): FoodHygieneRatingContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new FoodHygieneRatingContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new FoodHygieneRatingOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof FoodHygieneRatingError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new FoodHygieneRatingOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = FoodHygieneRatingMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new FoodHygieneRatingOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = FoodHygieneRatingMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new FoodHygieneRatingOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = FoodHygieneRatingMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FoodHygieneRatingSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = FoodHygieneRatingMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new FoodHygieneRatingResponse([]),
            'result' => new FoodHygieneRatingResult([]),
        ]);
        [, $err] = FoodHygieneRatingMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new FoodHygieneRatingSpec([]),
            'response' => null,
            'result' => new FoodHygieneRatingResult([]),
        ]);
        [, $err] = FoodHygieneRatingMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new FoodHygieneRatingSpec(['step' => 's']),
            'response' => new FoodHygieneRatingResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new FoodHygieneRatingResult([]),
        ]);
        [, $err] = FoodHygieneRatingMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new FoodHygieneRatingSpec(['step' => 's']),
            'response' => new FoodHygieneRatingResponse(self::resp(200, ['v' => 1])),
            'result' => new FoodHygieneRatingResult([]),
        ]);
        [, $err] = FoodHygieneRatingMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new FoodHygieneRatingSpec(['step' => 's']),
            'response' => new FoodHygieneRatingResponse(self::resp(200, ['v' => 2])),
            'result' => new FoodHygieneRatingResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        FoodHygieneRatingMakeResponse::call($ctx);
    ...
    {
        $preset = new FoodHygieneRatingResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new FoodHygieneRatingSpec([]),
            'response' => new FoodHygieneRatingResponse([]),
            'result' => new FoodHygieneRatingResult([]),
        ...
        [$got, $err] = FoodHygieneRatingMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new FoodHygieneRatingResult([])]);
        [, $err] = FoodHygieneRatingMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new FoodHygieneRatingSpec([]), 'result' => null]);
        [, $err] = FoodHygieneRatingMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FoodHygieneRatingSpec(['step' => 's']),
            'result' => new FoodHygieneRatingResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new FoodHygieneRatingOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FoodHygieneRatingMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FoodHygieneRatingSpec(['step' => 's']),
            'result' => new FoodHygieneRatingResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new FoodHygieneRatingOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FoodHygieneRatingMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FoodHygieneRatingResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new FoodHygieneRatingSpec([]),
            'result' => new FoodHygieneRatingResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = FoodHygieneRatingMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FoodHygieneRatingMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new FoodHygieneRatingError('boom', 'boom');
        $utility->fetcher = function (FoodHygieneRatingContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FoodHygieneRatingSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = FoodHygieneRatingMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (FoodHygieneRatingContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = FoodHygieneRatingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(FoodHygieneRatingResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        FoodHygieneRatingMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (FoodHygieneRatingContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FoodHygieneRatingSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = FoodHygieneRatingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new FoodHygieneRatingResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new FoodHygieneRatingSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = FoodHygieneRatingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = FoodHygieneRatingMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = FoodHygieneRatingMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new FoodHygieneRatingResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, FoodHygieneRatingDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new FoodHygieneRatingResult(['ok' => false])]);
        $this->expectException(FoodHygieneRatingError::class);
        FoodHygieneRatingDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new FoodHygieneRatingResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', FoodHygieneRatingMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        FoodHygieneRatingMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new FoodHygieneRatingBaseFeature();
        $b = new FoodHygieneRatingBaseFeature();
        FoodHygieneRatingFeatureAdd::call($ctx, $a);
        FoodHygieneRatingFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): FoodHygieneRatingBaseFeature
    {
        $f = new FoodHygieneRatingBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        FoodHygieneRatingFeatureAdd::call($ctx, self::named_feature('a'));
        FoodHygieneRatingFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        FoodHygieneRatingFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        FoodHygieneRatingFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        FoodHygieneRatingFeatureAdd::call($ctx, $replace);
        ...
        FoodHygieneRatingFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): FoodHygieneRatingContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new FoodHygieneRatingSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FoodHygieneRatingPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        FoodHygieneRatingPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new FoodHygieneRatingResponse(['headers' => null]),
            'result' => new FoodHygieneRatingResult([]),
        ]);
        FoodHygieneRatingResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        FoodHygieneRatingResultBody::call($ctx);
