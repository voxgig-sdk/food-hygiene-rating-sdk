...
class RatingDirectTest extends TestCase
{
    public function test_direct_list_rating(): void
    {
        $setup = rating_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-rating", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
