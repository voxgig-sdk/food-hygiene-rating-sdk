...
// FoodHygieneRating SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FoodHygieneRatingSDK::test)
...
{
    private const SDK_CLASS = 'FoodHygieneRatingSDK';
    ...
    private const SDK_BASE = 'foodhygienerating_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../foodhygienerating_sdk.php';
