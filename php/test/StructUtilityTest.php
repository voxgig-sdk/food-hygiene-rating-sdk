...
// FoodHygieneRating SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FoodHygieneRatingOmni::makeStructRunner(
    ...
    {
        return FoodHygieneRatingOmni::objmodel(FoodHygieneRatingOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return FoodHygieneRatingOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return FoodHygieneRatingOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FoodHygieneRatingOmni::structfix($now, Struct::undef()))
                        !== json_encode(FoodHygieneRatingOmni::structfix($val, Struct::undef()))) {
