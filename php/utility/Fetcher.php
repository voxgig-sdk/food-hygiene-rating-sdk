...
// FoodHygieneRating SDK utility: fetcher

class FoodHygieneRatingFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FoodHygieneRatingSDK/1.0)';
    ...
    public static function call(FoodHygieneRatingContext $ctx, string $fullurl, array $fetchdef): array
    {
