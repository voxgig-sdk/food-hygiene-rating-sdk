...
// FoodHygieneRating SDK utility: graphql
//
...
class FoodHygieneRatingGraphql
{
    ...
    // equivalent.
    public static function body(FoodHygieneRatingContext $ctx): mixed
    {
    ...
    public static function errors(FoodHygieneRatingContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
