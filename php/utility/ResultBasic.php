...
// FoodHygieneRating SDK utility: result_basic

class FoodHygieneRatingResultBasic
{
    public static function call(FoodHygieneRatingContext $ctx): ?FoodHygieneRatingResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof FoodHygieneRatingError) ? $result->err->msg : (string)$result->err;
