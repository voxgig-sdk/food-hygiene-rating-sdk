...
from foodhygienerating_sdk.utility import register

# Load features
from foodhygienerating_sdk.feature.base_feature import FoodHygieneRatingBaseFeature
from foodhygienerating_sdk.features import _make_feature
...
class FoodHygieneRatingSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FoodHygieneRatingUtility()
    ...
    def get_utility(self):
        return FoodHygieneRatingUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FoodHygieneRatingSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Authority(self, data=None) -> "AuthorityEntity":
        ...
        from foodhygienerating_sdk.entity.authority_entity import AuthorityEntity
    ...
    def BusinessType(self, data=None) -> "BusinessTypeEntity":
        ...
        from foodhygienerating_sdk.entity.business_type_entity import BusinessTypeEntity
    ...
    def Establishment(self, data=None) -> "EstablishmentEntity":
        ...
        from foodhygienerating_sdk.entity.establishment_entity import EstablishmentEntity
    ...
    def Rating(self, data=None) -> "RatingEntity":
        ...
        from foodhygienerating_sdk.entity.rating_entity import RatingEntity
