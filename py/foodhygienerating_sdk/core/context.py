...
from foodhygienerating_sdk.core.control import FoodHygieneRatingControl
...
from foodhygienerating_sdk.core.helpers import get_ctx_prop, to_map
...
class FoodHygieneRatingContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = FoodHygieneRatingControl()
        ...
        if isinstance(sp, FoodHygieneRatingSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FoodHygieneRatingResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FoodHygieneRatingResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return FoodHygieneRatingOperation({})
    ...
    def make_error(self, code, msg):
        return FoodHygieneRatingError(code, msg, self)
