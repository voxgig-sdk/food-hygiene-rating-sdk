...
class BusinessTypeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BusinessTypeEntity(self._client, opts)
    ...
    def data_get(self) -> BusinessType:
    ...
    def match_get(self) -> BusinessType:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[BusinessType]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.BusinessType().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
