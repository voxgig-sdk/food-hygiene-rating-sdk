# FoodHygieneRating SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from foodhygienerating_sdk import FoodHygieneRatingSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"FoodHygieneRatingSDK": FoodHygieneRatingSDK, "os": os}
        try:
