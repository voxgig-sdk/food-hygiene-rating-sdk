# FoodHygieneRating SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FoodHygieneRatingSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FoodHygieneRatingSDK(...) and FoodHygieneRatingSDK.test(...) become
#      FoodHygieneRatingSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "foodhygienerating_sdk"
_SDK_CLASS = "FoodHygieneRatingSDK"
