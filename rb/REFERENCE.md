...
```ruby
results, err = client.Authority.list(nil)
```
...
```ruby
results, err = client.BusinessType.list(nil)
```
...
```ruby
results, err = client.Establishment.list(nil)
```
...
```ruby
results, err = client.Rating.list(nil)
```
