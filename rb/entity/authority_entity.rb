...
class AuthorityEntity
  ...
  def make
    opts = @_entopts.dup
    AuthorityEntity.new(@_client, opts)
  end
  ...
  #   as an empty match, so client.Authority.load works with no args).
  ...
  #
  # @param reqmatch [AuthorityListMatch, Hash, nil] match filter (any subset of
  #   Authority fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
