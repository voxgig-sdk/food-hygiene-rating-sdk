...
class BusinessTypeEntity
  ...
  def make
    opts = @_entopts.dup
    BusinessTypeEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [BusinessTypeListMatch, Hash, nil] match filter (any subset of
  #   BusinessType fields); defaults to nil, treated as an empty match that lists all.
