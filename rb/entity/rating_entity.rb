...
class RatingEntity
  ...
  # @return [Rating, Hash] the current Rating data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Rating fields)
  def match_get
  ...
  #
  # @param reqmatch [RatingListMatch, Hash, nil] match filter (any subset of
  #   Rating fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Rating>, Array] the matching Rating items; raises FoodHygieneRatingError on failure
