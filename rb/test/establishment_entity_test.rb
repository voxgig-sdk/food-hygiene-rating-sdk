...
class EstablishmentEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set FOODHYGIENERATING_TEST_ESTABLISHMENT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def establishment_basic_setup(extra)
  ...
  entid_env_raw = ENV["FOODHYGIENERATING_TEST_ESTABLISHMENT_ENTID"]
