...
#      offline in seeded test mode (FoodHygieneRatingSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "FoodHygieneRating_sdk.rb")
  SDK_CLASS = "FoodHygieneRatingSDK"
  ...
  SDK_BASE = "FoodHygieneRating_sdk"
