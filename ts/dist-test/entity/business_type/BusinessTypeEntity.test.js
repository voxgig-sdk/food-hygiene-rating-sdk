...
(0, node_test_1.describe)('BusinessTypeEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/business_type/BusinessTypeTestData.json');
    ...
    let idmap = transform(['business_type01', 'business_type02', 'business_type03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=BusinessTypeEntity.test.js.map