...
(0, node_test_1.describe)('EstablishmentEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(establishment_ref01_data_dt0.id === establishment_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/establishment/EstablishmentTestData.json');
    ...
    let idmap = transform(['establishment01', 'establishment02', 'establishment03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=EstablishmentEntity.test.js.map