...
(0, node_test_1.describe)('RatingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-rating', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-rating', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['FOOD_HYGIENE_RATING_TEST_RATING_ENTID'];
...
//# sourceMappingURL=RatingDirect.test.js.map