...
function envOverride(m) {
    if ('TRUE' === process.env.FOOD_HYGIENE_RATING_TEST_LIVE ||
        'TRUE' === process.env.FOOD_HYGIENE_RATING_TEST_OVERRIDE) {
    ...
    m.FOOD_HYGIENE_RATING_TEST_EXPLAIN = process.env.FOOD_HYGIENE_RATING_TEST_EXPLAIN || m.FOOD_HYGIENE_RATING_TEST_EXPLAIN;
    return m;
}
