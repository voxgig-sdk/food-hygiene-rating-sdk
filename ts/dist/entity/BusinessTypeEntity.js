...
class BusinessTypeEntity extends FoodHygieneRatingEntityBase_1.FoodHygieneRatingEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'business_type';
        this.name_ = 'business_type';
        this.Name = 'BusinessType';
    }
    make() {
        return new BusinessTypeEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<BusinessType[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.BusinessTypeEntity = BusinessTypeEntity;
//# sourceMappingURL=BusinessTypeEntity.js.map