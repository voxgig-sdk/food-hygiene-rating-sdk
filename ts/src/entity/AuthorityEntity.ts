...
class AuthorityEntity extends FoodHygieneRatingEntityBase<Authority> {
  ...
  constructor(client: FoodHygieneRatingSDK, entopts: any) {
    ...
    this.name = 'authority'
    this.name_ = 'authority'
    this.Name = 'Authority'
  }


  make(this: AuthorityEntity) {
    return new AuthorityEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: AuthorityLoadMatch, ctrl?: Control): Promise<AuthorityEntity> {
  ...
  async list(this: any, reqmatch?: AuthorityListMatch, ctrl?: Control): Promise<AuthorityEntity[]> {
