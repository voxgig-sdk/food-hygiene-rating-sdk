...
class RatingEntity extends FoodHygieneRatingEntityBase<Rating> {
  ...
  make(this: RatingEntity) {
    return new RatingEntity(this._client, this.entopts())
  }
  ...
  async list(this: any, reqmatch?: RatingListMatch, ctrl?: Control): Promise<RatingEntity[]> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Rating[]> return stays clean under strict null checks.
